...
export default class LaptopRouter extends Component {
    ...
    Filter (num){
        ...
        switch(num){
            case 1:
                     element = products.filter(ele =>ele.price < 10000000 && ele.type ==='laptop');
                   
                    break;
            case 2:
                     element = products.filter(ele =>ele.price >= 10000000 && ele.price <15000000 && ele.type ==='laptop');
                   
                break;
            case 3:
                     element = products.filter(ele =>ele.price >= 20000000 && ele.price <25000000 && ele.type ==='laptop');
                  
                break;
            case 4:
                     element = products.filter(ele =>ele.price >= 30000000 && ele.type ==='laptop' );
        ...
        return (
            <div>
                ...
                <div className="row">
                    ...
                    this.state.element.length === 0 ? <h4 className ="ml-30">Không tìm thấy mặt hàng với giá yêu cầu</h4> :<Laptop products = {this.state.element}/>
